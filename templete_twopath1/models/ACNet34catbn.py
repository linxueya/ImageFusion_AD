...
class ACNet34catbn(BasicModule):
    def __init__(self, num_classes=4, pretrained=False):
        super(ACNet34catbn, self).__init__()

        self.model_name = 'ACNet34catbn'
    ...
    def _make_catconv(self, num_channel):
        cond = nn.Conv2d(num_channel * 2, num_channel , kernel_size=1)
        return cond
    ...
    def channel_attention(self, num_channel, ablation=False):
        ...
        activation = nn.ReLU(inplace=True)  # todo modify the activation function
